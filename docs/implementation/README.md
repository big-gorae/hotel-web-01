...
1. `지옥의 거울`의 추가 사용처
2. `room_108_entrails_bathtub`의 최종 해결법(MVP에서는 교체 가능한 4.2초 길게 누르기 사용)
3. `room_109_open_door`의 초기 조우 해결법

나머지 보류 항목은 런타임 확장 지점만 확보한다. 기존 기각안을 프로토타입이라는 이유로 되살리지 않는다.
