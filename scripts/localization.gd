...
var translations := {
	Language.ENGLISH: {
		...
		"ui.lobby.continue.disabled": "Save data will be available later.",
		"ui.lobby.quit": "Quit",
	...
	Language.KOREAN: {
		...
		"ui.lobby.continue.disabled": "저장 기능은 추후 제공됩니다.",
		"ui.lobby.quit": "종료",
	...
	Language.JAPANESE: {
		...
		"ui.lobby.continue.disabled": "セーブ機能は後日追加されます。",
		"ui.lobby.quit": "終了",
	...
	Language.RUSSIAN: {
		...
		"ui.lobby.continue.disabled": "Сохранения будут добавлены позже.",
		"ui.lobby.quit": "Выйти",
	...
	Language.CHINESE: {
		...
		"ui.lobby.continue.disabled": "保存功能稍后提供。",
		"ui.lobby.quit": "退出",
