...
var translations := {
	Language.ENGLISH: {
		...
		"ui.debug.cinematic.show": "Show cinematic frame",
		"ui.debug.cinematic.hide": "Hide cinematic frame",
	...
	Language.KOREAN: {
		...
		"ui.debug.cinematic.show": "시네마틱 프레임 보이기",
		"ui.debug.cinematic.hide": "시네마틱 프레임 숨기기",
	...
	Language.JAPANESE: {
		...
		"ui.debug.cinematic.show": "シネマティックフレームを表示",
		"ui.debug.cinematic.hide": "シネマティックフレームを非表示",
	...
	Language.RUSSIAN: {
		...
		"ui.debug.cinematic.show": "Показать кинематографическую рамку",
		"ui.debug.cinematic.hide": "Скрыть кинематографическую рамку",
	...
	Language.CHINESE: {
		...
		"ui.debug.cinematic.show": "显示电影画幅",
		"ui.debug.cinematic.hide": "隐藏电影画幅",
