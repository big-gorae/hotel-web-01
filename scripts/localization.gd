...
var translations := {
	Language.ENGLISH: {
		...
		"ui.lobby.subtitle": "Start a new shift or continue from a saved day.",
	...
	Language.KOREAN: {
		...
		"ui.lobby.subtitle": "새 근무를 시작하거나 저장된 day에서 이어서 시작합니다.",
	...
	Language.JAPANESE: {
		...
		"ui.day.label": "Day %d",
		"ui.lobby.title": "夜勤",
		"ui.lobby.subtitle": "新しい勤務を始めるか、保存済みの日から再開します。",
	...
	Language.RUSSIAN: {
		...
		"ui.lobby.subtitle": "Начните новую смену или продолжите с сохраненного дня.",
	...
	Language.CHINESE: {
		...
		"ui.day.label": "Day %d",
		"ui.lobby.title": "夜班",
		"ui.lobby.subtitle": "开始新的值班，或从已保存的日期继续。",
