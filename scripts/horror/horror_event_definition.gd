...
var collection_kind := "phenomenon"
var collection_title_key := ""
var collection_body_key := ""
...
func copy():
	...
	definition.collection_kind = collection_kind
	definition.collection_title_key = collection_title_key
	definition.collection_body_key = collection_body_key
