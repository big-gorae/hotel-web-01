...
static var ENTRIES := {
	...
	"laundry_red_washer": _entry(TYPE_ENTITY,
		"The Red Washer",
		"Something hidden among the laundry stains the washer glass red without changing its ordinary rhythm. Its completion music is not a sign of safety, but a ritual that forces the watcher to close their eyes and hide in the laundry room until the song ends.",
		"붉은 세탁기",
		"빨랫감 속에 숨은 무언가가 평범한 회전 속도를 유지한 채 세탁기 유리를 붉게 물들인다. 완료 음악은 안전 신호가 아니라, 노래가 끝날 때까지 목격자가 눈을 감고 세탁실에 숨게 하는 의식에 가깝다."),
