...
static func build_definitions() -> Array:
	return [
		...
		_make_rule("enter_open_room_109", 6, 3, ["room_109", "door", "anomaly", "false_rule"]),
		_make_rule("answer_before_thirteenth_ring", 7, 4, ["front_desk", "phone", "anomaly"]),
		_make_rule("stop_red_washer", 8, 5, ["laundry", "anomaly"]),
		_make_rule("sister_bloodied_false_rule_warning", 9, 3, ["story", "sister", "warning"]),
		_make_rule("ignore_sister_warning", 10, 3, ["story", "manager", "warning"]),
